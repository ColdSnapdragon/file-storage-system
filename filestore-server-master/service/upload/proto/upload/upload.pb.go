...
const file_upload_proto_rawDesc = "" +
	"\n" +
	"\fupload.proto\x12\x17go.micro.service.upload\"\n" +
	"\n" +
	"\bReqEntry\"O\n" +
	"\tRespEntry\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x14\n" +
	"\x05entry\x18\x03 \x01(\tR\x05entry2g\n" +
	"\rUploadService\x12V\n" +
	"\vUploadEntry\x12!.go.micro.service.upload.ReqEntry\x1a\".go.micro.service.upload.RespEntry\"\x00B\tZ\a/uploadb\x06proto3"
...
var file_upload_proto_goTypes = []any{
	(*ReqEntry)(nil),  // 0: go.micro.service.upload.ReqEntry
	(*RespEntry)(nil), // 1: go.micro.service.upload.RespEntry
}
var file_upload_proto_depIdxs = []int32{
	0, // 0: go.micro.service.upload.UploadService.UploadEntry:input_type -> go.micro.service.upload.ReqEntry
	1, // 1: go.micro.service.upload.UploadService.UploadEntry:output_type -> go.micro.service.upload.RespEntry
